...
app.delete('/sessions/:id', uuidAuth, async c => {
  ...
  // deleteSession reaps the child itself — a worker_status that reads
  // "offline" while the bridge's child is still alive would otherwise orphan
  // it onto a capacity slot.
